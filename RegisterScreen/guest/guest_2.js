  ...
  handleChoosePhoto = () => {
    ...
    render() {
      ...
      return (
        ...
        {
          this.state.belongs && this.state.firstname_kr  && this.state.lastname_kr  && this.state.firstname_eu && this.state.lastname_eu && this.state.photo?
        <TouchableOpacity onPress={() => this.props.navigation.navigate('Signin_guest3',{
