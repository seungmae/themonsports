    ...
    render() {
      ...
      return (
        ...
        
        {
          ...
          <Input placeholder='생년월일(숫자만 입력, 예_780205)*' placeholderTextColor='#ffb400'
        ...
        </TouchableOpacity>
        {
          ...
          && this.state.phone_length == 11 && this.state.birthday_length == 6
          && this.state.phone_validate && this.state.phone_validate && this.state.birthday_validate && this.state.ephone_validate ?
          <TouchableOpacity onPress={() => this.props.navigation.navigate('Signin_guest4',{
