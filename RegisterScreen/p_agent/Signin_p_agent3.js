...
class Signin_p_agent extends React.Component { //진행요원
  ...
  componentDidMount() {
    ...
    console.log(this.state.otherbelong)
    console.log(this.state.belongs)
  }
    render() {
      ...
      return (
        ...
        {
          this.state.registration_num_validate && this.state.unifomsize
          && this.state.phone_length == 11
          && this.state.phone && registration_num_validate2 && this.state.phone_validate && this.state.ephone_validate?
          <TouchableOpacity onPress={() => this.props.navigation.navigate('Signin_p_agent4',{
