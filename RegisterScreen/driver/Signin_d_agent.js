...
import { Dimensions, View, Text,Alert, TouchableOpacity,TouchableWithoutFeedback,Keyboard,SafeAreaView,Platform } from 'react-native';
      ...
      return (
...

        {
          ...
          <View>
            ...
            style={{position: 'absolute', top:110, right: 0 ,zIndex:1, backgroundColor:'white',
        ...
        {
          this.state.email != null && this.state.password != null && this.state.email_distinct
           && this.state.email_validate && this.state.password === this.state.password2 
          ?
          <TouchableOpacity onPress={() => this.props.navigation.navigate('Signin_d_agent2',{
